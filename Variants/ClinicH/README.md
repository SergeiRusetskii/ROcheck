...
[![Version](https://img.shields.io/badge/version-1.6.1-blue.svg)](https://github.com/SergeiRusetskii/ROcheck16/releases)
[![Eclipse API](https://img.shields.io/badge/Eclipse%20API-16.1-green.svg)](https://varianapis.github.io/)
...
1. Download the latest `ROcheck.esapi.dll` from [Releases](https://github.com/SergeiRusetskii/ROcheck16/releases)

2. Copy the DLL to your Eclipse 16.1 plugins directory:
   ```
   C:\Program Files (x86)\Varian\RTM\16.1\esapi\plugins\
   ```

3. Restart Eclipse

4. The script will appear in the Scripts menu as **"ROcheck v1.6.1"**
...
2. **Navigate to**: Scripts → ROcheck v1.6.1
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/SergeiRusetskii/ROcheck16.git
   cd ROcheck16
   ```

2. **ESAPI references are pre-configured for Eclipse 16.1:**
   - `ROcheck.csproj` already references:
     ```xml
...
### v1.6.1 (2026-01-16) - Current Release (Eclipse 16.1)
- ✅ Adapted from v1.6.0 for Eclipse 16.1 compatibility
- ✅ Updated DLL references to Eclipse 16.1 API paths
- ✅ All ESAPI methods verified available in Eclipse 16.1
- ✅ No code changes required - 100% API compatible
- ✅ Documentation updated for Eclipse 16.1 deployment

### v1.6.0 (2025-12-16) - Base Release (Eclipse 18.1)
...
**Powered by**: Varian Eclipse Scripting API v16.1
