...
namespace ROcheck.Validators
{
    ...
    public class ClinicalGoalsCoverageValidator : ValidatorBase
    {
        ...
        public ClinicalGoalsCoverageValidator(IValidationConfig config)
        {
            _config = config;
        }
            ...
            List<ValidationResult> results)
        {
            ...
            foreach (var structure in structures)
            {
                ...
                if (ValidationHelpers.IsStructureExcluded(structure, prescriptionTargetIds, _config.ExcludedStructures))
                    continue;
