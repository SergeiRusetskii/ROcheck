    ...
    public class PTVBodyProximityValidator : ValidatorBase
    {
        ...
        public override IEnumerable<ValidationResult> Validate(ScriptContext context)
        {
            ...
            var bodyStructure = context.StructureSet.Structures
                .FirstOrDefault(s => s.Id.Equals(_config.BodyStructureId, StringComparison.OrdinalIgnoreCase)
            ...
            if (ptvProximities.Any())
            {
                ...
                var ptvsTooClose = ptvProximities.Where(p => p.Distance <= _config.PTVBodyProximityThresholdMm).ToList();
